						...
						<c:forEach items="${panier.items}" var="item">
							<tr>
								<td class="cart_product"><a href=""><img
										src="data:image/jpeg;base64,${item.image}" style="width: 100"
										alt=""></a></td>
								<td class="cart_description" style="width: 400px">
									<h4>
										<a href="">${item.nomProduit}</a>
									</h4>
								...
								<td class="cart_quantity">
									<div class="cart_quantity_button">
										...
										<input disabled class="cart_quantity_input" type="text"
											name="quantity" value="${item.quantitePanier}"
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li>TOTAL TVQ : <span>${panier.totalTVQ} $</span>
							</li>

							<li>TOTAL TPS : <span>${panier.totalTPS} $</span>
							</li>
