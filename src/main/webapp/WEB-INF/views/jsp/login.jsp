...
<html>
<head>
    <script type="<%=request.getContextPath()%>/resources/assets/js/calendrier.js" src="calendrier.js"></script>
    <link rel="stylesheet" media="screen" type="<%=request.getContextPath()%>/resources/assets/css/design.css" title="Design" href="design.css" />
    <meta charset="utf-8">
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<%=request.getContextPath()%>/resources/assets/images/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<%=request.getContextPath()%>/resources/assets/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<%=request.getContextPath()%>/resources/assets/images/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="<%=request.getContextPath()%>/resources/assets/images/ico/apple-touch-icon-57-precomposed.png">
...
<%@include file="header_top.jsp" %>
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h2><b>Connectez-vous à votre compte</b></h2>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<p><font color="red">${errorsInscription}</font></p>
						<p><font color="red">${succes}</font></p>
						 <f:form cssClass="form-signin" action="inscription.html" method="post" modelAttribute="client">
	...
	<script src="<%=request.getContextPath()%>/resources/assets/js/price-range.js"></script>
